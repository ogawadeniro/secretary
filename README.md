...
| レイヤー | 役割 | キーファイル |
|----------|------|-------------|
| `domain/` | エンティティ、リポジトリポート | `Schedule.java`, `ScheduleRepository.java`, `CalendarShare.java`, `User.java` |
| `application/` | ユースケース | `ScheduleUseCase.java`, `ScheduleService.java`, `CustomUserDetailsService.java` |
